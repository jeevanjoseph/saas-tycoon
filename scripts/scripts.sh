...
docker pull mongo:7 &&\
 ...
 docker pull ghcr.io/jeevanjoseph/saas-tycoon-client:latest &&\
 ...
 docker push artifactory-phx-prod.cdaas.oraclecloud.com/docker-spectra-platform-dev/ossp-demo-apps/saas-tycoon/saas-tycoon-client:latest &&\
...
ossp-cli delete workload-deployment --fleet ossp-demo --env ossp-demos saas-tycoon
